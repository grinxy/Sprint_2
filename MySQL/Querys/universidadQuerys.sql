...
SELECT * FROM departamento INNER JOIN profesor ON departamento.id = profesor.id_departamento;
SELECT departamento.nombre, profesor.id_profesor FROM departamento INNER JOIN profesor ON departamento.id = profesor.id_departamento;
